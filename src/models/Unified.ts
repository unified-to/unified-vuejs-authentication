...
==============
*/
export const ApiCallType = ['login', 'webhook', 'inbound'] as const;
...
export const IntegrationSupportWebhookType = ['virtual', 'native'] as const;

export type TIntegrationSupportWebhookType = (typeof IntegrationSupportWebhookType)[number];

export const IssueStatus = ['COMPLETED', 'NEW', 'ROADMAP', 'IN_PROGRESS', 'ON_HOLD', 'VALIDATING', 'REJECTED'] as const;
...
export const PlanTerm = ['monthly', 'yearly'] as const;

export type TPlanTerm = (typeof PlanTerm)[number];

export const SupportInboundType = ['supported-required', 'supported', 'not-supported'] as const;

export type TSupportInboundType = (typeof SupportInboundType)[number];

export const SupportOutboundType = ['supported', 'not-supported'] as const;

export type TSupportOutboundType = (typeof SupportOutboundType)[number];

export const WebhookDatabaseType = ['mongodb', 'mysql', 'postgres', 'mssql', 'mariadb'] as const;

export type TWebhookDatabaseType = (typeof WebhookDatabaseType)[number];

export const WebhookDataType = ['INITIAL-PARTIAL', 'INITIAL-COMPLETE', 'VIRTUAL', 'NATIVE'] as const;

export type TWebhookDataType = (typeof WebhookDataType)[number];

export const WebhookEvent = ['updated', 'created', 'deleted'] as const;
