...
dc: PropType<"us" | "eu" | "au" | "" | undefined>;
environment: StringConstructor;
title: StringConstructor;
description: StringConstructor;
sUrl: StringConstructor;
fUrl: StringConstructor;
scopes: PropType<string[]>;
state: StringConstructor;
pretext: StringConstructor;
includeText: BooleanConstructor;
includeIcon: BooleanConstructor;
}>, {
error: string;
}, {
api_url: string;
authintegrations: IIntegration[];
